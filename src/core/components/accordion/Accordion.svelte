...
<script lang="ts">
    ...
    let buttonClassesCSS = `${classes} flex items-center justify-between w-full p-5 font-medium text-left border border-gray-200 rounded-xl focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800`
...
<div id="accordion-collapse" data-accordion={isOpen ? 'open' : 'collapse'}>
    <h2 id="accordion-collapse-heading-1">
        ...
        >
            ...
            <svg
                data-accordion-icon
                class="w-3 h-3 {isOpen ? 'rotate-180' : ''} shrink-0"
                aria-hidden="true"
